...
public class CellBecomesPopulated {
    ...
    public void empty_cell_becomes_populated_when_it_has_three_neighbours() {
        ...
        twoDimensionalSpace.registerCell(new Cell(new Point(0, 0)));
        ...
        assertTrue(twoDimensionalSpace.contains(new Cell(new Point(1, 1))));
    }
    ...
    public void cell_with_fewer_than_two_neighbours_dies() {
        ...
        assertFalse(twoDimensionalSpace.contains(new Cell(new Point(0, 0))));
    }
    ...
    public void cell_with_two_neighbours_lives_on() {
        ...
        twoDimensionalSpace.registerCell(new Cell(new Point(0, 0)));
        twoDimensionalSpace.registerCell(new Cell(new Point(1, 0)));
        twoDimensionalSpace.registerCell(new Cell(new Point(2, 0)));

        twoDimensionalSpace.tick();

        assertTrue(twoDimensionalSpace.contains(new Cell(new Point(1, 0))));
        assertTrue(twoDimensionalSpace.contains(new Cell(new Point(1, 1))));
    }
    ...
    public void cell_with_more_than_three_neighbours_dies() {
        ...
        twoDimensionalSpace.registerCell(new Cell(new Point(1, 2)));

        twoDimensionalSpace.tick();

        assertFalse(twoDimensionalSpace.contains(new Cell(new Point(1, 1))));
    }
}
