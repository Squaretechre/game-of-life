...
public class GameOfLifeTests {
    ...
    public void cell_with_two_neighbours_lives_on() {
        ...
        Cell cell3 = new Cell(point3, cells, twoDimensionalSpace, new Neighbourhood(point3, twoDimensionalSpace));
        Cell cell4 = new Cell(point4, cells, twoDimensionalSpace, new Neighbourhood(point4, twoDimensionalSpace));
    ...
    public void cell_with_more_than_three_neighbours_dies() {
        ...
        Cell cell5 = new Cell(point5, cells, twoDimensionalSpace, new Neighbourhood(point5, twoDimensionalSpace));

        Cell cell6 = new Cell(point6, cells, twoDimensionalSpace, new Neighbourhood(point6, twoDimensionalSpace));
        Cell cell7 = new Cell(point7, cells, twoDimensionalSpace, new Neighbourhood(point7, twoDimensionalSpace));
        Cell cell8 = new Cell(point8, cells, twoDimensionalSpace, new Neighbourhood(point8, twoDimensionalSpace));
        Cell cell9 = new Cell(point9, cells, twoDimensionalSpace, new Neighbourhood(point9, twoDimensionalSpace));
        Cell cell10 = new Cell(point10, cells, twoDimensionalSpace, new Neighbourhood(point10, twoDimensionalSpace));
        Cell cell11 = new Cell(point11, cells, twoDimensionalSpace, new Neighbourhood(point11, twoDimensionalSpace));
        Cell cell12 = new Cell(point12, cells, twoDimensionalSpace, new Neighbourhood(point12, twoDimensionalSpace));
        Cell cell13 = new Cell(point13, cells, twoDimensionalSpace, new Neighbourhood(point13, twoDimensionalSpace));
